...
if __name__=='__main__':
    ...
    model = FaceCNN_initial(num_input_channels=num_input_channels, num_classes=num_ppl).to(device)
    ...
    print("Peak mem usage:", used_mem[0])   # this is the usage of ALL processes on GPU
                                            # torch per-process is NOT accurate
                                            # (gives lower values than actual)